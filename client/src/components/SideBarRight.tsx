export const SideBarRight: React.FC = () => {
    return (
        <div className="space-y-6">
            {/* Suggestions */}
            <div>
                <h3 className="font-semibold text-sm text-gray-900 mb-3">Suggestions for you</h3>
            ...
            <div>
                ...
                <p className="text-sm text-gray-700 hover:text-blue-500 cursor-pointer">#photography</p>
                <p className="text-sm text-gray-700 hover:text-blue-500 cursor-pointer">#travel</p>
                <p className="text-sm text-gray-700 hover:text-blue-500 cursor-pointer">#food</p>
                <p className="text-sm text-gray-700 hover:text-blue-500 cursor-pointer">#nature</p>
                </div>
            </div>
        </div>
    );
